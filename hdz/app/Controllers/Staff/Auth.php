...
class Auth extends BaseController
{
    public function login()
    {
        if($this->request->getPost('do') == 'login'){
            ...
            }elseif (!$data = $this->staff->getRow(['email' => $this->request->getPost('email')])) {
            ...
            if (defined('HDZDEMO')) {
                ...
                elseif($this->request->getPost('do') == 'update_password')
                {
                    ...
                    if($validation->withRequest($this->request)->run() == false){
                        ...
                        $dataUser = findUserByEmail($this->staff->getData('email')); 

                        #Update password User
                        if($dataUser != null){
                            updatePasswordUser($dataUser->id, $dataUser->email, $this->request->getPost('new_password'));  
                        }  
