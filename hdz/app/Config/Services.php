...
use App\Libraries\SystemParams;
use App\Libraries\SettingsDepartment;
use App\Libraries\SettingsAbo;
use App\Libraries\TraceProcess;
use App\Libraries\LoanPayments;
...
class Services extends \CodeIgniter\Config\Services
{
    ...
    public static function params($getShared = true)
    {
        if($getShared){
            return static::getSharedInstance('params');
        }
        return new SystemParams();
    }

    public static function settingsDep($getShared = true)
    {
        if($getShared){
            return static::getSharedInstance('settingsDep');
        }
        return new SettingsDepartment();
    }

    public static function settingsAbo($getShared = true)
    {
        if($getShared){
            return static::getSharedInstance('settingsAbo');
        }
        return new SettingsAbo();
    }

    public static function TraceProcess($getShared = true)
    {
        if($getShared){
            return static::getSharedInstance('traceProcess');
        }
        return new TraceProcess();
    }

    public static function loanPayment($getShared = true)
    {
        if($getShared){
            return static::getSharedInstance('loanPayment');
        }
        return new LoanPayments();
    }
