...
<!-- Verifico si objeto tiene el valor de asesor para cargar 
    o no la tabla si el envio tiene respuesta -->                                   
    <?php 
    $asr = "";
    ...
    <?php if ( $asr != "" ): ?>
        ...
        <!-- Para mostrar mensajes del cliente sin tabla inicial-->
    <?php else: ?>
