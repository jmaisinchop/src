...
echo 'Activar mi Cuenta - Austrobank';
$this->endSection();
?>
...
<div class="container" style="max-width: 550px; margin-top: 4rem; margin-bottom: 4rem;">
    <div class="auth-card">
        <div class="text-center mb-4">
            <h2 class="mt-3">Activar mi Cuenta</h2>
            <p class="text-muted">Si ya has enviado tickets anteriormente, ingresa tu correo para recibir tu contraseña de acceso.</p>
        </div>
        ...
        <?= form_open(route_to('portal_claim_process')) ?>
        <?= csrf_field() ?>
            ...
            <div class="form-group">
                ...
                <small class="form-text text-muted">Ingresa tu nombre solo si deseas actualizarlo.</small>
            </div>
            ...
            <button type="submit" id="submit-btn" class="btn btn-austro btn-block" disabled>Enviar Contraseña a mi Correo</button>
