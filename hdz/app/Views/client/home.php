                                ...
                                <div class="col-lg-6 mt-4">
                                    <div class="pt-2">
                                        <a class="kb_category" href="<?php echo site_url(route_to('category', $item->id, url_title($item->name)));?>">
                                            <!-- <i class="fa fa-folder-open-o kb_article_icon pr-2"></i> -->
                                            <i class="far fa-folder-open kb_article_icon pr-2"></i> <?php echo $item->name;?>
                                        </a>
                                    ...
                                    <?php foreach (kb_articles_category($item->id) as $article):?>
                                        <div class="py-2">
                                            ...
                                            <i class="far fa-file-alt kb_article_icon pr-3"></i>
