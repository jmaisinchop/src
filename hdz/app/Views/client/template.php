...
<head>
    ...
    echo link_tag('favicon.ico','icon','image/x-icon').
        ...
        script_tag('assets/components/jquery/jquery.min.js');
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <?php else:?>
                    <li class="nav-item dropdown <?php if($page_controller == 'login'){ echo 'active';}?>">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo lang('Client.login.menu');?>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="<?php echo site_url(route_to('login'));?>"><?php echo lang('Client.login.menuEnviar');?></a>
                            <a class="dropdown-item" href="<?php echo site_url(route_to('staff_logout'));?>"><?php echo lang('Client.login.menuRecibir');?></a>
                        </div>
                    </li>
                <?php endif;?>
            </ul>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 text-md-right">
                Powered by <a href="http://www.helpdeskz.com" target="_blank">HelpDeskZ</a>
            </div>
        </div>
    </div>
</div>
