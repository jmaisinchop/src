        ...
        <div class="table-responsive">
            <table class="table table-hover table-striped">
                ...
                <tr>
                    ...
                    <th><?php echo lang('Client.form.dptsAdjuntoList');?></th>
                    <th><?php echo lang('Client.form.priority');?></th>
                ...
                if($result_data){
                    foreach ($result_data as $item){
                        ...
                        <tr>
                            ...
                            <td><?php echo getNamesDepAdjuntosById($item->department_id_child); ?></td>
                            <td style="color:  <?php echo $item->priority_color; ?>"><?php echo $item->priority_name;?></td>
                            <td>
                                <?php
                                switch ($item->status){
                                    case 1:
                    ...
                    ?>
                    <tr>
                        <td colspan="6"><?php echo lang('Client.error.recordsNotFound');?></td>
                    </tr>
                    <?php
                }
                ?>
