...
<div class="container-fluid">
    <div class="row">
        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
            ...
            <?php 
                /*echo '<pre>';
                print_r(getParamTextArray('MENU_SEND_EMAILS') );
                echo '</pre>';
                echo staff_data('id')*/
             ?>
            <div class="nav-wrapper">
                <ul class="nav flex-column">
                    ...
                    <!-- Sección menú para mostrar los trace de los procesos -->
                    <li class="nav-item dropdown <?php echo (uri_page() == 'trace' ? 'show' : '');?>">
                        <a class="nav-link dropdown-toggle <?php echo (uri_page() == 'trace' ? 'active' : '');?>" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="true">
                            <i class="fas fa-list-ul"></i>
                            <span><?php echo lang('Admin.abo.menuList');?></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-small <?php echo (uri_page() == 'trace' ? 'show' : '');?>">
                            <a class="dropdown-item <?php echo strpos(uri_string(), 'trace/emails') !== false ? 'active' : '';?>" 
                                href="<?php echo site_url(route_to('staff_emails_client'));?>"><?php echo lang('Admin.abo.clientEmail');?>
                            </a>
                            <a class="dropdown-item <?php echo strpos(uri_string(), 'trace/allprocess') !== false ? 'active' : '';?>" 
                                href="<?php echo site_url(route_to('staff_allprocess'));?>"><?php echo lang('Admin.abo.menuAllProcess');?>
                            </a>
                        </div>
                    </li>

                    <?php
                    $departments = staff_data('department');
                    if((is_array($departments) && in_array(14, $departments)) || staff_data('admin') == 1) {
                    ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo strpos(uri_string(), 'report/form') !== false ? 'active' : ''; ?>" href="<?php echo site_url(route_to('staff_report_form')); ?>">
                    ...
                    if(staff_data('admin') == 1){
                        ...
                        <!-- Sección menú para mostrar las opciones de configuración de ABO -->
                        <li class="nav-item dropdown <?php echo (uri_page() == 'abo' ? 'show' : '');?>">
                            <a class="nav-link dropdown-toggle <?php echo (uri_page() == 'abo' ? 'active' : '');?>" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="true">
                                <i class="fas fa-building"></i>
                                <span><?php echo lang('Admin.abo.menu');?></span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-small <?php echo (uri_page() == 'abo' ? 'show' : '');?>">
                                <a class="dropdown-item <?php echo strpos(uri_string(), 'abo/setup') !== false ? 'active' : '';?>" 
                                    href="<?php echo site_url(route_to('staff_settings_abo'));?>"><?php echo lang('Admin.abo.settingsABO');?>
                                </a>
                                <a class="dropdown-item <?php echo strpos(uri_string(), 'abo/attachments') !== false ? 'active' : '';?>" 
                                    href="<?php echo site_url(route_to('staff_attachments_department'));?>"><?php echo lang('Admin.abo.settingsAttachments');?>
                                </a>
                                <a class="dropdown-item <?php echo strpos(uri_string(), 'abo/tsolicitudes') !== false ? 'active' : '';?>" 
                                    href="<?php echo site_url(route_to('staff_types_solicitude'));?>"><?php echo lang('Admin.abo.settingsSolicitudes');?>
                                </a> 
                                <a class="dropdown-item <?php echo strpos(uri_string(), 'abo/params') !== false ? 'active' : '';?>" 
                                    href="<?php echo site_url(route_to('staff_params_settings'));?>"><?php echo lang('Admin.abo.sparams');?>
                                </a>
                            </div>
                        </li>
        ...
        <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
                    ...
                    <ul class="navbar-nav border-left flex-row ">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-small">
                                ...
                                <a class="dropdown-item text-danger" href="<?php echo site_url();?>">
            ...
            <footer class="main-footer d-flex mt-3 p-2 px-3 bg-white border-top">
              ...
              <a href="https://helpdeskz.com" rel="nofollow" target="_blank">HelpDeskZ v<?php echo HDZ_VERSION;?></a>
            </span>
            </footer>
        </main>
    </div>
...
<script>
    ...
    var langRemoveAttachmentConfirmation = '<?php echo addcslashes(lang('Admin.abo.removeConfirmationAD'), "'");?>';
...
echo script_tag('assets/components/jquery/jquery.min.js').
    ...
    script_tag('assets/helpdeskz/js/abohelpdesk.js');
