...
?>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group">
                <label><?php echo lang('Admin.tools.columns');?></label>
                <input type="number" name="column" class="form-control" 
                value="<?php echo set_value ('column', isset ($customField) ? $customField->columns : '' ) ?>">
                <small class="text-muted form-text"><?php echo lang_replace('Admin.tools.columnsBootstrapDescription', ['[a]' => '<a href="https://getbootstrap.com/docs/4.6/layout/grid/#auto-layout-columns" target="_blank">', '[/a]' => '</a>']);?></small>
            </div> 
            <div class="form-group">
