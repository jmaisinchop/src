...
?>
    ...
    <div class="input-group input-group-seamless  mb-3">
        <input name="fullname" class="navbar-search form-control" type="text" value="<?php echo esc(\Config\Services::request()->getGet('fullname'));?>" 
        placeholder="<?php echo lang('Admin.agents.searchAgent');?>..." aria-label="Search"> 
                ...
                if($agents_list){
                    foreach ($agents_list as $agent){
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo getNamesDepAdjuntosById($agent->department);?>
                            </td>
