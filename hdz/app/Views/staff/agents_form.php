        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <div class="custom-control custom-checkbox">
                    <input type="checkbox" name="createUser" class="custom-control-input" id="createUser">
                    <label class="custom-control-label" for="createUser"><?php echo lang('Admin.users.newUserFromAgente');?></label>
                </div>
            </div>
            <div class="form-group">
