...
class Attachments
{
    ...
    #Para descargar archivos desde UPLOADS
    public function downloadFilesUser($nameFile)
    {
        $response = Services::response();
        return $response->download( WRITEPATH.'uploads'.DIRECTORY_SEPARATOR.$nameFile, null)
    ...
    {
        $response = Services::response();
        return $response->viewPDF( WRITEPATH.'attachments'.DIRECTORY_SEPARATOR.$file->enc, null);
            //->setFileName($file->name);
    }
